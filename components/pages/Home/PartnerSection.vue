<template>
  <div class="tw-mx-[16px] md:tw-mx-[120px] lg:tw-mx-[240px] tw-my-[50px]">
    ...
    >
    <BaseText class="tw-text-grey600">Luôn đặt uy tính lên hàng đầu</BaseText>
...
import { showAlertPlaneTicket } from "@/mixins/common";
